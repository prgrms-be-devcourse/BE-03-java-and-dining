...
public class CustomerReservationInfoProj {
	...
	public boolean equals(Object o) {
		...
		return noShowCount == that.noShowCount && visitedCount == that.visitedCount && Objects.equals(
			lastVisitedDateTime, that.lastVisitedDateTime);
	}

	@Override
	public int hashCode() {
		return Objects.hash(noShowCount, visitedCount, lastVisitedDateTime);
	}
